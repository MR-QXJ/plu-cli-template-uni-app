...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"uni-test","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.modal = modal;exports.previewFile = previewFile;exports.changeLocalUser = changeLocalUser;exports.choosePermitImg = choosePermitImg;exports.chooseImgShop = chooseImgShop;exports.updateProcess = updateProcess;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 9));
var _http = __webpack_require__(/*! @/network/http */ 12);
var _global = __webpack_require__(/*! ./global */ 13);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function

modal(_x, _x2) {return _modal.apply(this, arguments);}
...
//图片或文件预览
function _modal() {_modal = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(content, options) {var _conf$;var conf;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return uni.showModal(_objectSpread({ content: content, confirmColor: '#305AF5', cancelColor: '#999' }, options));case 2:conf = _context.sent;return _context.abrupt("return", (_conf$ = conf[1]) === null || _conf$ === void 0 ? void 0 : _conf$.confirm);case 4:case "end":return _context.stop();}}}, _callee);}));return _modal.apply(this, arguments);}function previewFile(_x3, _x4) {return _previewFile.apply(this, arguments);}
...
/**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 */function _previewFile() {_previewFile = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(path, load) {var splitPot, fileType, filePath;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:if (!/\.(png|jpg|gif|jpeg|webp)$/.test(path)) {_context2.next = 2;break;}return _context2.abrupt("return", uni.previewImage({ urls: [path] }));case 2:load && uni.showLoading({ title: '加载中...' }); //文件
            splitPot = path.split('.');fileType = splitPot[splitPot.length - 1];_context2.next = 7;return (0, _http.downLoadFile)(path, false);case 7:filePath = _context2.sent;uni.openDocument({ filePath: filePath, fileType: fileType, fail: function fail(err) {console.log(err);uni.showToast({ title: '文件打开失败', icon: 'none' });}, complete: function complete() {load && uni.hideLoading();} });case 9:case "end":return _context2.stop();}}}, _callee2);}));return _previewFile.apply(this, arguments);}function changeLocalUser(key, value) {
  var userMsg = JSON.parse(uni.getStorageSync(_global.LOCAL_USER) || '{}');
  uni.setStorageSync(_global.LOCAL_USER, JSON.stringify(userMsg, function (k, val) {
...
/**
   * @desc  选择图片方式自定义弹出表
   */function
choosePermitImg() {return _choosePermitImg.apply(this, arguments);}
...
/**
                                                                     ...
                                                                     */function _choosePermitImg() {_choosePermitImg = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {var _choose$;var res, choose, tapIndex, itemMap, sourceType;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:_context3.next = 2;return uni.showActionSheet({ itemList: ['从相册中选择', '拍照'], itemColor: "#366FFF" });case 2:choose = _context3.sent;tapIndex = (_choose$ = choose[1]) === null || _choose$ === void 0 ? void 0 : _choose$.tapIndex;itemMap = { 0: 'album', 1: 'camera' };sourceType = itemMap[tapIndex];if (!sourceType) {_context3.next = 10;break;}_context3.next = 9;return chooseImgShop([sourceType]);case 9:res = _context3.sent;case 10:return _context3.abrupt("return", res);case 11:case "end":return _context3.stop();}}}, _callee3);}));return _choosePermitImg.apply(this, arguments);}function
chooseImgShop(_x5) {return _chooseImgShop.apply(this, arguments);}
...
//小程序更新机制
function _chooseImgShop() {_chooseImgShop = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4(sourceType) {var _cres$;var cres;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:_context4.next = 2;return uni.chooseImage({ count: 1, sizeType: ['original', 'compressed'], sourceType: sourceType });case 2:cres = _context4.sent;return _context4.abrupt("return", (_cres$ = cres[1]) === null || _cres$ === void 0 ? void 0 : _cres$.tempFiles);case 4:case "end":return _context4.stop();}}}, _callee4);}));return _chooseImgShop.apply(this, arguments);}function updateProcess() {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.get = get;exports.post = post;exports.uploadPic = uploadPic;exports.downLoadFile = downLoadFile;var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 9));var _global = __webpack_require__(/*! @/utils/global */ 13);
var _api = __webpack_require__(/*! ./api */ 14);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function

post(_x, _x2) {return _post.apply(this, arguments);}function _post() {_post = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(url, data) {var load,header,localUser,res,_args = arguments;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:load = _args.length > 2 && _args[2] !== undefined ? _args[2] : true;
            load && uni.showLoading({
              title: '加载中...' });

            header = {};
            // header['Content-Type'] = 'application/x-www-form-urlencoded'
            localUser = uni.getStorageSync(_global.LOCAL_USER);
            if (localUser) {
              ...
              then(checkStatus).
              then(checkCode));case 7:res = _context.sent;

            load && uni.hideLoading();return _context.abrupt("return",

            res);case 10:case "end":return _context.stop();}}}, _callee);}));return _post.apply(this, arguments);}function

get(_x3, _x4) {return _get.apply(this, arguments);}
...
/**
                                                     ...
                                                     */function _get() {_get = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2(url, data) {var header, localUser, res;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:uni.showLoading({ title: '加载中...' });header = {}; // header['Content-Type'] = 'application/x-www-form-urlencoded'
            localUser = uni.getStorageSync(_global.LOCAL_USER);if (localUser) {header['token'] = JSON.parse(localUser).token || '';}_context2.next = 6;return uni.request({ method: 'GET', header: header, data: data, url: _api.ROOT + url }).then(checkStatus).then(checkCode);case 6:res = _context2.sent;uni.hideLoading();return _context2.abrupt("return", res);case 9:case "end":return _context2.stop();}}}, _callee2);}));return _get.apply(this, arguments);}function uploadPic(_x5) {return _uploadPic.apply(this, arguments);}
...
/**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            * @param {Boolean} load 是否加载动画
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            */function _uploadPic() {_uploadPic = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3(path) {var load,ures,_args3 = arguments;return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:load = _args3.length > 1 && _args3[1] !== undefined ? _args3[1] : true;if (path) {_context3.next = 3;break;}return _context3.abrupt("return");case 3:load && uni.showLoading({ mask: true, title: '加载中...' });_context3.next = 6;return uni.uploadFile({ url: _api.UPLOAD_IMG, filePath: path, header: { 'Content-Type': 'multipart/form-data' }, name: 'images', formData: { folder: 1 } }).then(checkStatus).then(checkCode);case 6:ures = _context3.sent;load && uni.hideLoading();if (!ures) {_context3.next = 10;break;}return _context3.abrupt("return", JSON.parse(ures));case 10:case "end":return _context3.stop();}}}, _callee3);}));return _uploadPic.apply(this, arguments);}function
downLoadFile(_x6) {return _downLoadFile.apply(this, arguments);}function _downLoadFile() {_downLoadFile = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4(url) {var _dlRes$;var load,dlRes,res,_args4 = arguments;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:load = _args4.length > 1 && _args4[1] !== undefined ? _args4[1] : true;if (
            url) {_context4.next = 3;break;}return _context4.abrupt("return");case 3:
            load && uni.showLoading({
              title: '加载中...' });_context4.next = 6;return (

              uni.downloadFile({ url: url }));case 6:dlRes = _context4.sent;

            res = (_dlRes$ = dlRes[1]) === null || _dlRes$ === void 0 ? void 0 : _dlRes$.tempFilePath;
            load && uni.hideLoading();if (!
            res) {_context4.next = 11;break;}return _context4.abrupt("return",
            res);case 11:

            uni.showToast({
              title: '文件下载失败',
              icon: 'none' });case 12:case "end":return _context4.stop();}}}, _callee4);}));return _downLoadFile.apply(this, arguments);}
...
function checkStatus(http) {
  ...
  var message = codeMsg[code] || "\u8FDE\u63A5\u9519\u8BEF".concat(code);
    ...
    if (code === 2) {
      ...
      uni.showModal({
        ...
        success: function success(mres) {
          if (mres.confirm) {var _currentPage$$page;
            // 退出重新登录
            var user = {
              token: null,
              userId: "",
            ...
            var pages = getCurrentPages();
            var currentPage = pages[1] || pages[0];
            var redirect = currentPage === null || currentPage === void 0 ? void 0 : (_currentPage$$page = currentPage.$page) === null || _currentPage$$page === void 0 ? void 0 : _currentPage$$page.fullPath;
            uni.redirectTo({
              url: "/pages/profile/login?redirect=".concat(redirect) });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.LOCAL_USER = void 0; // 全局常量

//用户信息缓存key
var LOCAL_USER = 'storage_user_mp';exports.LOCAL_USER = LOCAL_USER;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.UPLOAD_IMG = exports.LOGIN = exports.ROOT = void 0; //请求根路径
var ROOT = 'http://api.certificate.uuudoo.com';

//登录
exports.ROOT = ROOT;var LOGIN = "".concat(ROOT, "/Passport/login");
//图片上传
exports.LOGIN = LOGIN;var UPLOAD_IMG = "".concat(ROOT, "/System/upload");exports.UPLOAD_IMG = UPLOAD_IMG;
